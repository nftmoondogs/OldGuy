...
export const Uiaftersex = () => {
    return (        
        <div>
            ...
            <a href='https://pump.fun/board'><FiExternalLink style={{marginTop:"10px"}} size={25}/></a>
            <a href='https://telegram.me/'><FaTelegramPlane style={{marginLeft: "10px", marginRight: "7px"}} size={30}/></a>
        </div>
    )
}
...
export const Socials = () => {
    return (        
        <div style={{margin:"auto",textAlign:"center"}}> 
            ...
            <a href='https://telegram.me/'><FaTelegramPlane style={{marginLeft: "10px", marginRight: "7px"}} size={40}/></a>
            </p>
        </div>
    )
}
