...
export const ExploreAI = () => {
    return (      
        ...
        <div>
            ...
            <a href='https://pump.fun/GVynWMor2wowc8mXXeqC1kxREKsTAiewM9MmJyLPbbM5'><FiExternalLink style={{marginTop:"10px"}} size={25}/></a>
        </div>
...
export const Uiaftersex = () => {
    return (        
        <div>
            ...
            <a href='https://pump.fun'><FiExternalLink style={{marginTop:"10px"}} size={25}/></a>
